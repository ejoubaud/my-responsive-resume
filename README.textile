...
* You can enter personal informations, such as your name and desired job (_title_ and _subtitle_, required), your current location, birth date, email and phone number (optional). Email and phone number are obfuscated for spam crawlers.
...
*** Labelled *data* are just additional data about your point (client, employer...) with a label. In @Client: "My client"@, @Client@ is the label and @My client@ is the data. They will be displayed beneath your point's title to add additional informations about the point. They are optional.
